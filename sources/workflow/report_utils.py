...
def parse_cur_exec_report(report_file: Path) -> TestSuite:
    """ Parses the last execution report (xml) generated by pytest. Returns the parsed suite. """
    global _TESTSUITE
...
def get_current_suite() -> TestSuite:
    """ Returns the last execution report (xml) generated by pytest. """
    return _TESTSUITE
