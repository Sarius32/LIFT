...
print(f"✅ Table for FSS Coverages over all trials generated: {(tables_path / "fss_cov_table.tex")}")
...
print(f"✅ Table for LPS Coverages over all trials generated: {(tables_path / "fss_cov_table.tex")}")
